...
const Navbar = ({ setMode, onEdit, onDelete, searchTerm, onSearchChange }) => {
  ...
  return (
    <nav className="flex justify-between p-4  bg-slate-600 text-white">
      <div className="text-lg font-bold">Employee App</div>
      <div className="flex space-x-2 max-sm:flex-col">
